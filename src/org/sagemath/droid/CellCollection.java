...
public class CellCollection {
	...
	public static void initialize(Context context) {
		if (instance.data != null)
			return;
		instance.JSONParser = new CellCollectionJSONParser(context,
				JSONfilename);
	...
	public static void notifyGroupsChanged() {
		...
		/*
		 * instance.context.sendBroadcast(new
		 * Intent().setAction("GROUPS_CHANGED"));
		 */
	}
